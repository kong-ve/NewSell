        ...
        ! function(e, t, a) {
            ...
            computed: {
                ...
                winConfig: function() {
                    ...
                    }, this.navStyle.backgroundColor && (this.navStyle.backgroundImage = "none"), t.navigationBarBorderColor ? this.navStyle.borderBottom = "1px solid " + t.navigationBarBorderColor : this.navStyle.borderBottom = "0", t
                },
                isTabBar: function() {
        ...
        t.default = {
            ...
            methods: {
                ...
                swipeChange: function(e) {
                    console.log(e), 0 == this.playing ? (ui.createVideoContext(this.appData.videoList[e].uid).play(), this.playing = !0) : (ui.createVideoContext(this.appData.videoList[e].uid).pause(), this.playing = !1)
                },
                swipeStart: function(e) {
                    console.log(e), ui.createVideoContext(this.appData.videoList[this.appData.page].uid).pause(), this.appData.page = e, ui.createVideoContext(this.appData.videoList[e].uid).play(), this.playing = !0
                },
                facebook: function() {
                    FB.init({
            ...
            created: function() {
                this.getSystemInfo();
                var e = ui.getApp();
                this.appData = e.globalData, ui.createVideoContext(this.appData.videoList[0].uid).play()
            }
        }
    },
    183: function(e, t) {},
